---
name: papermaking-process
description: Paper machine process physics, canonical units, valid operating ranges, mass-balance and transport-delay equations. Use whenever writing or reviewing code that simulates, models, predicts, or validates paper machine variables - basis weight, moisture, ash, caliper, stock flow, filler flow, steam pressure, machine speed - or when checking whether generated data is physically plausible.
