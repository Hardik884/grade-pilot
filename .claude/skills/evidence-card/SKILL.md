---
name: evidence-card
description: The provenance format that every prediction and recommendation must carry - required fields, source tagging taxonomy, and the grounding rules for LLM narration. Use whenever building the advisor, the evidence layer, the narrator, or any dashboard component that displays a suggestion or a rationale.
user-invocable: false
---

# Evidence card

Satisfies the deliverable "tag every suggestion with possible source of inference".
No number reaches the operator without one.
